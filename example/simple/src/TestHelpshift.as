...
package
{
	...
	/**	
	 * Sample application for using the Helpshift Native Extension
	 */
	public class TestHelpshift extends Sprite
	{
		...
		private function init( ):void
		{
			try
			{
				message( "Helpshift Supported: " + Helpshift.isSupported );
				message( "Helpshift Version:   " + Helpshift.service.version );
